...
%setup -q -n beeswarm
pushd ..
cp -a beeswarm buildavx2
popd
pushd ..
cp -a beeswarm buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1737135359
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/beeswarm/libs/beeswarm.so
/V4/usr/lib64/R/library/beeswarm/libs/beeswarm.so
